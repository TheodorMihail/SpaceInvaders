...
namespace SpaceInvaders.Scenes.Expedition
{
    ...
    /// <summary>The shape of a generated map and what each of its nodes can hold.</summary>
    [CreateAssetMenu(fileName = "ExpeditionMapDataConfig", menuName = "SpaceInvaders/Expedition/Expedition Map Data Config")]
    public class ExpeditionMapDataConfigSO : ScriptableObject, IRepositoryObject
    {
        [Header("Map Shape")]
        ...
        public virtual string ObjectID => nameof(ExpeditionMapDataConfigSO);
    }
}
